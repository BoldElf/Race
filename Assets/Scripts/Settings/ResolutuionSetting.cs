...
[CreateAssetMenu]
public class ResolutuionSetting : Setting
{
    [SerializeField]
    ...
    public override bool isMaxValue { get => currentResolutionIndex == avalibalResolutions.Length - 1; }
    ...
    {
        currentResolutionIndex = PlayerPrefs.GetInt(title, avalibalResolutions.Length - 1);
    }
